...
export default function AddProducts() {
  ...
  useEffect(() => {
    // Fetch categories from the backend or define them statically
    const fetchedCategories = ['Electronics', 'Clothing', 'Home & Kitchen', 'Books', 'Toys'];
  ...
  const addProduct = async (e) => {
    ...
    try {
      ...
      formDataForBackend.append('category', category);
